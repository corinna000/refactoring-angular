(function () {
  ...
  describe('bracket manager service', function () {
    ...
    beforeEach(inject(function (bracketManager, _$rootScope_, TrackFactory) {
      sut = bracketManager;
      ...
      tracks = tracks.map(function (track) {
        return TrackFactory.create(track);
      });
    ...
    describe('voting', function () {
      ...
      beforeEach(inject(function (TrackFactory) {
        round = 0;
        track = TrackFactory.create({ id: 100, description: 'my track' });
      }));
